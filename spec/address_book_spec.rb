  ...
  describe "#import_from_csv" do
    ...
    describe "import from entries_2.csv" do
      ...
      it "imports the 1st entry" do
          ...
          # Check first entry
          entry_one = book.entries[0]
          check_entry(entry_one, "Amber", "555-555-3660", "amber@blocmail.com")
        end
        ...
        it "imports the 2nd entry" do
          ...
          # Check the second entry
          entry_two = book.entries[1]
          check_entry(entry_two, "Cali", "555-555-2036", "cali@blocmail.com")
        end
        ...
        it "imports the 3rd entry" do
          ...
          # Check the third entry
          entry_three = book.entries[2]
          check_entry(entry_three, "Rita", "555-555-4646", "rita@blocmail.com")
        end
      end
